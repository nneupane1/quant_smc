...
Example:
    python -m quant_system.data.ingest.kraken_download ^
        ...
        --interval 1 ^
        --start-year 2013 ^
        --output data/raw/BTCUSD_1m_kraken.csv
"""
...
def main():
    ...
    parser.add_argument("--output", default="data/raw/kraken_ohlcv.csv", help="Output CSV path")
    ...
    requested_end_ts = int(dt.datetime(end_year, 1, 1).timestamp())
    ...
    if args.append and os.path.exists(args.output):
        last_ts = _tail_timestamp(args.output)
        if last_ts:
