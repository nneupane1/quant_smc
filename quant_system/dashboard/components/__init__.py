...
from quant_system.dashboard.components.py.report_generator import BacktestReportGenerator as ReportGenerator
from quant_system.dashboard.components.py.report_page import render_report_page as ReportPage
